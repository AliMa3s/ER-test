...
(function () {
  ...
  const I18N = {
    nl: {
      ...
      aboutDisclaimer: 'Enkel ter oefening. Het echte examen kan licht of sterk verschillen. Dit zijn voorgestelde oefenroutes en geen officiële examenroutes. De bestuurder moet alle manoeuvres volledig beheersen. Bevestig altijd de details bij het examencentrum.',
      aboutCredits: 'Met dank aan M Q Aslam en Saleha Q Aslam voor hun hulp bij het bouwen van dit project.',
    ...
    en: {
      ...
      aboutDisclaimer: 'Practice guidance only. The actual exam may differ slightly or greatly. These are suggested practice routes and not official exam routes. The driver must still master all maneuvers. Always confirm details with the exam center.',
      aboutCredits: 'Credits: With thanks to M Q Aslam and Saleha Q Aslam for helping build this project.',
    ...
    fr: {
      ...
      aboutDisclaimer: 'À titre indicatif uniquement. L\'examen réel peut différer légèrement ou fortement. Ce sont des itinéraires de pratique suggérés et non des itinéraires officiels. Le conducteur doit toujours maîtriser toutes les manœuvres. Confirmez toujours les détails avec le centre d\'examen.',
      aboutCredits: 'Crédits : merci à M Q Aslam et Saleha Q Aslam pour leur aide dans la création de ce projet.',
